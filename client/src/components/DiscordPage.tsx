    ...
    <div className="min-h-screen flex items-center justify-center relative">
      ...
      >
        ...
        >
          ...
          <MessageCircle className="h-12 w-12 text-[#a78bfa] relative z-10" />
        </motion.div>
        ...
        >
          Rejoins notre communauté Discord pour échanger avec les autres membres et participer aux appels de groupe
        </motion.p>
